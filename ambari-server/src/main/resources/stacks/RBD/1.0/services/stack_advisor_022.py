...
from stack_advisor_021 import RBD021StackAdvisor

class RBD022StackAdvisor(RBD021StackAdvisor):

  def getServiceConfigurationRecommenderDict(self):
    parentRecommendConfDict = super(RBD022StackAdvisor, self).getServiceConfigurationRecommenderDict()
  ...
  def recommendYARNConfigurations(self, configurations, clusterData, services, hosts):
    super(RBD022StackAdvisor, self).recommendYARNConfigurations(configurations, clusterData, services, hosts)
  ...
  def recommendHDFSConfigurations(self, configurations, clusterData, services, hosts):
    super(RBD022StackAdvisor, self).recommendHDFSConfigurations(configurations, clusterData, services, hosts)
  ...
  def recommendHIVEConfigurations(self, configurations, clusterData, services, hosts):
    super(RBD022StackAdvisor, self).recommendHiveConfigurations(configurations, clusterData, services, hosts)
  ...
  def recommendHBASEConfigurations(self, configurations, clusterData, services, hosts):
    super(RBD022StackAdvisor, self).recommendHbaseConfigurations(configurations, clusterData, services, hosts)
  ...
  def recommendStormConfigurations(self, configurations, clusterData, services, hosts):
    super(RBD022StackAdvisor, self).recommendStormConfigurations(configurations, clusterData, services, hosts)
  ...
  def recommendRangerConfigurations(self, configurations, clusterData, services, hosts):
    super(RBD022StackAdvisor, self).recommendRangerConfigurations(configurations, clusterData, services, hosts)
  ...
  def getServiceConfigurationValidators(self):
    parentValidators = super(RBD022StackAdvisor, self).getServiceConfigurationValidators()
    childValidators = {
  ...
  def validateHiveConfigurations(self, properties, recommendedDefaults, configurations, services, hosts):
    parentValidationProblems = super(RBD022StackAdvisor, self).validateHiveConfigurations(properties, recommendedDefaults, configurations, services, hosts)
  ...
  def getMastersWithMultipleInstances(self):
    result = super(RBD022StackAdvisor, self).getMastersWithMultipleInstances()
    result.extend(['METRICS_COLLECTOR'])
    return result

  def getNotValuableComponents(self):
    result = super(RBD022StackAdvisor, self).getNotValuableComponents()
    result.extend(['METRICS_MONITOR'])
    return result

  def getCardinalitiesDict(self):
    result = super(RBD022StackAdvisor, self).getCardinalitiesDict()
    result['METRICS_COLLECTOR'] = {"min": 1}
    return result

  def getAffectedConfigs(self, services):
    affectedConfigs = super(RBD022StackAdvisor, self).getAffectedConfigs(services)
